...
##### 3#         楼主| 发表于 2022-10-22 17:10
 ...
 本帖最后由 JudgmentEye 于 2022-10-24 00:50 编辑 

FF8高清贴图汉化版解压即玩版，无需按教程一步步解包替换，已修复电波塔字库乱码

如果报错，把config.zip里面的目录解压到C:\Users\用户名\Documents\My Games下
...
##### 64#       发表于 2022-10-23 22:57
 ...
 本帖最后由 毛利提督 于 2022-10-23 23:28 编辑 

电脑上从没有运行过2019版FF8的千万不要用3L的整合版！

mod说明第一条就强调在打mod之前<strong>必须先进一次游戏</strong>，目的是生成系统文件和存档文件

打了mod之后游戏文件结构变了，需要读取我的文档/我的游戏里的系统设定文件才能进入游戏

整合版出bug是因为之前电脑上没有运行过游戏，游戏没有在生成游戏系统文件和存档文件，然后你没有系统文件导致读取不到，进不去游戏

不信的话可以去试试我的文档/My Games下把FINAL FANTASY VIII Remastered文件夹丢到回收站去（别真删了），再用mod版进游戏，100%可以复现进不了游戏的BUG

前面进不去的删了整合版，重新从steam下载纯净的1.03版官方游戏，进一次游戏然后自己一步步打补丁

或者就用主楼链接里提供的盗版去搞，一样记得进一次游戏再折腾mod

另外，操作正常打完补丁的话是可以直接用FFVIII.exe进游戏的
...
##### 67#         楼主| 发表于 2022-10-24 00:41
 ...
 本帖最后由 JudgmentEye 于 2022-10-24 01:02 编辑 
...
感谢指点，设定文件加上了，顺便问一下怎样改FFVIII_JP.dll的程序代码能把设置和存档保存到游戏安装目录下？
...
##### 91#       发表于 2022-11-7 00:37
 ...
 本帖最后由 HJJSM 于 2022-11-7 00:50 编辑 

EBML header parsing failed   咦 重新进几次就好了  <img src="https://static.saraba1st.com/image/smiley/face2017/057.png" referrerpolicy="no-referrer">
...
##### 92#       发表于 2022-11-7 11:29
 ...
 本帖最后由 sunnyjee 于 2022-11-7 11:34 编辑 
...
把三楼包里的config文件拷贝到对应位置 记得修改config文件里的分辨率为deck的分辨率 不然分辨率会有错（steamdeck生成的环境没有My Games文件夹要自己新建注意大小写）
